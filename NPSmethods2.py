...
def showExampleImg(imgDir, numOfImgsInEachRun, parameter, \
    ...
    pc = ax_atom.pcolor(atomODAvg, cmap=cm.jet, vmin=vRange[0], vmax=.5)
...
def fplot_NPS_Exp(K_x, K_y, M2k_Exp, if_Save=False, saveDir=None, axes=None, cMap=cm.jet, vRange=None):
    ...
    if vRange == None:
        ...
        pc_NPS_Exp = ax_NPS_Exp.pcolor(K_x, K_y, M2k_Exp, cmap=cMap, vmin=vRange[0], vmax=.5)
...
def fplot_NPS_ExpAndFit(K_x, K_y, M2k_Exp, M2k_Fit=None, if_Save=False, saveDir=None, fig=None, cMap=cm.jet, \
    ...
    pc_NPS_Exp = ax_NPS_Exp.pcolor(K_x, K_y, M2k_Exp, cmap=cMap, vmin=vMin_Exp, vmax=.5)
    ...
    pc_NPS_Fit = ax_NPS_Fit.pcolor(K_x, K_y, M2k_Fit, cmap=cMap, vmin=vMin_Fit, vmax=.5)
